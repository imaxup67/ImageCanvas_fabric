...
<body>
	<div class="container">
		...
		<img src="../uploads/butterfly-3054736_1920.jpg" id="my-image" style="display:none">
	</div>
    ...
    <script type="text/javascript">     		   	
		...
		var imgn = ""; var canvasWidth = 0;
     	$(document).ready(function(){
     		var imgnn = "butterfly-3054736_1920.jpg";
			...
			canvas.setZoom(1);
			canvas.add(imgInstance);canvasData = JSON.stringify(canvas.toJSON());
     	...
     	$("#saveIMG").on("click",function(){
			$("canvas").get(0).toBlob(function(blob){
				saveAs(blob,"butterfly-3054736_1920.jpg.png");
			})
		})	
		$("#zoomreset").click(function(){
			...
			$("#resvg").click(function(){
				document.location="../svgs/butterfly-3054736_1920.php";
			})
     </script>
