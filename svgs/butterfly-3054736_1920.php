<!DOCTYPE html>
	<html>
		<head>
			...
			<title>butterfly-3054736_1920</title>
		...
		<body id="body1">
			<div class="container" >
				<div class="row">
					...
					<div class="col-md-8 " id="title">
						<h2> File Name : "butterfly-3054736_1920" </h2>
					</div>
				</div>
			...
			<div id="container" style="margin-left:4%;width:80%; height:1000px;">
				<svg id="svgl" version="1.1" xmlns="http://www.w3.org/2000/svg" width="888px" height="1000px" viewBox="0 0 888 1000" xml:space="preserve">
					<g id="regions"></g></svg></div>
			<script type="text/javascript">
	     			
		     	$("#body1").on("dblclick",function(e){
		     		$("#note").css("display","none");
		     		if(e.target.tagName != "path"){		     			
		     			$("#container").html('<svg id=\"svgl\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" width=\"888px\" height=\"800px\" viewBox=\"0 0 888 1000\" xml:space=\"preserve\"><g id=\"regions\"></g></svg>');	
				...
				$("#saveIMG").on("click",function(){
					$("#canvas").get(0).toBlob(function(blob){
						saveAs(blob,"butterfly-3054736_1920.png");
					})
				})
				...
				$("#can").on("click",function(){
					...
					pathG = [];
					fabric.Image.fromURL("../uploads/butterfly-3054736_1920.jpg", function(img) {
				    img.scaleToWidth(888);img.scaleToHeight(800);var group = new fabric.Group([ img  ]);
			...
			<style>
				...
				#svgl{
					background-image: url("../uploads/butterfly-3054736_1920.jpg");
            ...
            selectmode();
			    ...
			    init();
			    var paths = [], canvasPathD = [], canvasPathFill = [], canvasPathS = [], canvasPathW=[];$("#redo").click(function(){
					$.ajax({
						url: "../public/savecanvas.php",
						type: "post",
						data:{
							"paths":paths,
							"imgName":"butterfly-3054736_1920",
							"imgfullname":"butterfly-3054736_1920.jpg",
							"num" : "0",
						...
						success: function(result){
							document.location = "../canvas/butterfly-3054736_1920.php";
